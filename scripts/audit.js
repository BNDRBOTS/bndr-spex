...
const serverChecks = [
  ...
  ['Structured schema validation', /schemaKeys[\s\S]*structured_schema[\s\S]*validation_flags[\s\S]*failure_modes[\s\S]*fallback_recovery_logic[\s\S]*acceptance_criteria[\s\S]*meta_tag[\s\S]*Structured schema failed validation/],
